...
office_sim: main.o Office.o Stack.o Queue.o LinkedList.o Document.o
	g++ -g main.o Office.o Stack.o Queue.o LinkedList.o Document.o -o office_sim

Document.o: Document.h Document.cpp
	g++ -g -c Document.cpp

Stack.o: Stack.cpp Stack.h Document.h LinkedList.h
	g++ -g -c Stack.cpp

Queue.o: Queue.cpp Queue.h Document.h LinkedList.h
	g++ -g -c Queue.cpp

Office.o: Office.h Office.cpp Document.h
	g++ -g -c Office.cpp

LinkedList.o: LinkedList.h LinkedList.cpp Document.h
